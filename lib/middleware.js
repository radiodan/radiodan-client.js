var clientRegex  = new RegExp('/client.js$'),
    ...
    fs           = require('fs'),
    clientLib    = fs.readFileSync(__dirname + '/../static/client.js').toString(),
    actionJSON   = fs.readFileSync(__dirname + '/../static/actions.json').toString(),
    messagingClient = require('./messaging-client'),
    radiodan     = require('./radiodan-client').create(messagingClient.create()),
    radios       = {};

clientLib = clientLib.replace('{{actions}}', actionJSON);

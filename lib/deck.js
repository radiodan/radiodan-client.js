...
module.exports.create = function (id, client) {
  ...
  */
  ...
  instance.volume = function (params) {
    return sendCommandForAction('player.volume', params);
  };

  instance.add = function (params) {
    return sendCommandForAction('playlist.add', params);
  };

  instance.play = function (params) {
    return sendCommandForAction('player.play', params);
  };

  instance.updateDatabase = function () {
    return sendCommandForAction('database.update');
  };
